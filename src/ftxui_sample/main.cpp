...
// configuration step. It creates a namespace called `best_practices_starter`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", best_practices_starter::cmake::project_name, best_practices_starter::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", best_practices_starter::cmake::project_version);
      return EXIT_SUCCESS;
    }
